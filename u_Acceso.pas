...
// Validar el inicio de sesión usando el Data Module
  ShowMessage(edtUsername.Text + ' ' + edtPassword.Text);
  {if fMainReport.IniciarSesion(edtUsername.Text, edtPassword.Text) then
    begin
        // Si el inicio de sesión es exitoso, muestra el formulario principal
            //Application.CreateForm(TfMainReport, fMainReport); // Crear y mostrar el Data Module principal
                //fMainReport.Show;  // Mostrar el formulario principal
                    Close;           // Destruir el formulario de inicio de sesión
                      end
                        else
                            begin
                                  ShowMessage('Acceso denegado. Usuario o contraseña incorrectos o acceso restringido.');
                                        Close;
                                            end;}
